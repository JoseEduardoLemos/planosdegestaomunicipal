    ...
    <div>
      ...
      <header>
        ...
        <div className='cardsindex'>
          <CardMunicipio title={cidade1.nome} link ="../pages/cidades/[id].tsx" imgsrc={cidade1.urlbrasao}/>
          <CardMunicipio title={cidade2.nome} link ="/cidades/idCidade"  imgsrc={cidade2.urlbrasao}/>
        </div>
    </div>
  )
}
