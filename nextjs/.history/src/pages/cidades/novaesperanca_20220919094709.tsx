...
export default function NovaEsperanca(){
    return (
      <div>
        <NavBar></NavBar>
        <br></br>
        <div id="titulosite">
          <h1 className="titulocidade">Planos de Gestão Municipal para Nova Esperança</h1>
          <img className="imagemtitulocidade" src='https://upload.wikimedia.org/wikipedia/commons/d/d4/Bras%C3%A3o_Nova_Esperan%C3%A7a%2C_PR%2C_Brazil.png'></img>
        </div>
        <Grupo 
