...
export default function Cidade({plano,listaGrupoLink}){
  return(
    <div>
      <header>
      <NavBar></NavBar>  
      ...
      <div id="titulosite">
        <h1 className="titulocidade">{`Planos de Gestão para ${plano.descricao}`}</h1>
        <img className="imagemtitulocidade"src={plano.urlbrasao}></img>  
      </div>
