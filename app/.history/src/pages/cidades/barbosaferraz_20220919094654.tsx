...
export default function BarbosaFerraz(){
    return (
      <div>
        <NavBar></NavBar>
        <br></br>
        <div id="titulosite">
          <h1 className="titulocidade">Planos de Gestão Municipal para Barbosa Ferraz</h1>
          <img className="imagemtitulocidade" src='https://www.mbi.com.br/mbi/files/media/image/simbolopedia/municipio-barbosa-ferraz-brasao-simb-brsspr0200502505.jpg'></img>
        </div>
        <Grupo 
