    ...
    <div>
      ...
      <header>
        ...
        <div className='cardsindex'>
          <CardMunicipio title={cidade1.nome} link ="/cidades/astorga" imgsrc={cidade.urlbrasao}/>
          <CardMunicipio title={cidade2.nome} link ="/cidades/loanda"  imgsrc="https://upload.wikimedia.org/wikipedia/commons/e/ef/Bras%C3%A3o_de_Loanda.png"/>
        </div>
    </div>
  )
}
