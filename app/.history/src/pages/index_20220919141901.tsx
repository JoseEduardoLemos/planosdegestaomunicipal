    ...
    <div>
      ...
      <header>
        ...
        <div className='cardsindex'>
          <CardMunicipio title={cidade1.nome} link ="/src/pages/cidades/astorga" imgsrc={cidade1.urlbrasao}/>
          <CardMunicipio title={cidade2.nome} link ="/corbelia"  imgsrc={cidade2.urlbrasao}/>
        </div>
    </div>
  )
}
